...
(function () {
  ...
  const animateCount = (el) => {
    ...
    // raw override lets us count to 5 but display 5.99, etc.
    ...
    if (prefersReduced) { el.textContent = prefix + fmt(finalVal) + suffix; return; }
    ...
    const tick = (now) => {
      ...
      else el.textContent = prefix + fmt(finalVal) + suffix;
    };
